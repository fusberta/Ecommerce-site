            ...
            <section className="mt-16">
                <div className="p-12 w-2/3 m-auto max-w-4xl mx-auto border-2 border-double rounded-xl bg-white drop-shadow-lg">
                    ...
                    <div className="mt-14 flex flex-start">
                        ...
                        <div className="ml-6 grid grid-cols-2 items-center gap-4">
                            ...
                            <div className=""></div>
                            <button className="bg-emerald-600 text-base text-zinc-100 py-2 px-4 rounded-md w-max">Сохранить изменения</button>
                        </div>
                    </div>
                </div>
            </section>
